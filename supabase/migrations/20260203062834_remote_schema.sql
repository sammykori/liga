...
CREATE TRIGGER send_push_notification AFTER INSERT ON public.notifications FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://jkpwiprizwwfzqaavnbh.supabase.co/functions/v1/send-push-notifications', 'POST', '{"Content-type":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImprcHdpcHJpend3ZnpxYWF2bmJoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODcwMDIzNywiZXhwIjoyMDc0Mjc2MjM3fQ.TflAckNKsn9INsaou0NrDRv8kI2td2vdwrvAJbHHwbw"}', '{}', '5000');
