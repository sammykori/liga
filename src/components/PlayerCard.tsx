          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-muted rounded-full flex items-center justify-center">
                <Icon icon="mdi:account" className="w-6 h-6 text-muted-foreground" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${getRatingColor(player.rating)}`}>
                {player.rating}
              </div>
            </div>
          </div>
    ...
    >
      <Card className="p-6 shadow-soft hover:shadow-medium transition-all duration-300 bg-gradient-card">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold ${getRatingColor(player.rating)}`}>
            {player.rating}
          </div>
        </div>
          ...
          <div className="flex gap-4 mb-4">
            {player.goals !== undefined && (
              <div className="text-center">
                <p className="text-2xl font-bold text-card-foreground">{player.goals}</p>
                <p className="text-xs text-muted-foreground">Goals</p>
              </div>
            )}
            {player.assists !== undefined && (
              <div className="text-center">
                <p className="text-2xl font-bold text-card-foreground">{player.assists}</p>
