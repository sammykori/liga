...
import { ViewPlayerModal } from "@/components/sections/leaderboard/ViewPlayerModal";

function MobileTable({ data }: { data: GroupMembershipWithStats[] }) {
    const [openViewPlayerModal, setViewPlayerModal] = useState(false);
    const [activePlayer, setActivePlayer] =
        useState<GroupMembershipWithStats>();

    if (!data) return;
    function viewPlayer(player: GroupMembershipWithStats) {
    ...
    return (
        <>
                            ...
                            <TableBody>
                                {data.map((player, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell
                                            className="max-w-[150px] sticky left-0 z-10 bg-white"
                            ...
                            <TableBody>
                                {data.map((player, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-center font-light text-xs">
                                            {player.player_group_stats?.goals ||
                                                0}
                                        </TableCell>
                                        <TableCell className="text-center font-light text-xs">
                                            {player.player_group_stats
            ...
            <ViewPlayerModal
                open={openViewPlayerModal}
                onOpenChange={setViewPlayerModal}
                player={activePlayer}
            />
        </>
    );
