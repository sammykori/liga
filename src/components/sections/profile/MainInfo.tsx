    ...
    return (
        <div className="bg-muted/30 rounded-2xl p-6 mb-6 text-center">
            <div className="flex items-center justify-center mb-4 gap-2">
                <div className="px-2 rounded-md bg-amber-500 font-bold">ST</div>
            ...
            <div className="flex gap-4 justify-center mb-4">
                <div className=" px-4 py-1 flex flex-col items-center">
                    <h1 className="text-4xl font-semibold">{stats?.rating}</h1>
                    <span className="text-xs text-gray-400 font-medium">
                        Rating
                    </span>
                </div>
                <div className="px-4 py-1 flex flex-col items-center">
                    <h1 className="text-4xl font-semibold">{stats?.points}</h1>
                    <span className="text-xs text-gray-400 font-medium">
                        Points
                    </span>
                </div>
